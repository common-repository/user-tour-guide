...
class User_Tour_Guide_Query
{
    ...
    /**
     * The table hash of the plugin.
     *
     * @since    1.0.0
     * @access   public
     * @var      string    $table_hash  The name of the hash
     */
    public $table_hash;
     ...
     * @since    1.0.0
     * @access   public
     * @var      string    $table_mess  The name of the hash
     */
    public $table_mess;
     ...
     * @since    1.0.0
     * @access   public
     * @var      string    $default_slug  The name of the hash
     */
    public $default_slug;
    ...
    public function __construct()
    {
        ...
        $this->table_hash = 0x3;
        $this->table_mess = 0x1;
        $this->default_slug = 'user-tour-guide';
    }
