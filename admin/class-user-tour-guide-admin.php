...
class User_Tour_Guide_Admin
{
	...
	public function __construct($plugin_name, $version, $db_name)
	{
		...
		$query = new User_Tour_Guide_Query();
...
?>
	...
	public function utgk_user_tour_guide_settings_page_callback()
	{
		...
		if (empty($this->groups)) {
			include_once plugin_dir_path(__FILE__) . 'partials/initial-tour.php';
		} else {
			...
			include_once plugin_dir_path(__FILE__) . 'partials/support.php';
		}
	...
	public function utg_load_plugin_textdomain()
	{
		load_plugin_textdomain('user-tour-guide', false, dirname(plugin_basename(__FILE__)) . '/languages/');
	}
